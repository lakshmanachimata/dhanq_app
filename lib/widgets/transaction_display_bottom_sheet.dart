...
class TransactionDisplayBottomSheet extends StatelessWidget {
  ...
  const TransactionDisplayBottomSheet({
    Key? key,
                ...
                children: [
                  ...
                  ListView.builder(
                    ...
                    itemBuilder: (context, transactionIndex) {
                      final transaction = transactions[transactionIndex] as List;
                      ...
                      final isCredit = type == 1 || type == 4; // CREDIT or INTEREST
                      final isDebit = type == 2 || type == 6 || type == 7; // DEBIT, INSTALLMENT, or CLOSING
